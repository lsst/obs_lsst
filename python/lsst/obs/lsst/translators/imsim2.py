...
__all__ = ("LsstCamImSim2Translator", )
...
from .lsst import SIMONYI_TELESCOPE, FILTER_DELIMITER
...
LSST_CAM_IMSIM_2 = "LSSTCam-imSim-2"


class LsstCamImSim2Translator(LsstSimTranslator):
    """Metadata translation for imSim 2.0 Camera."""

    name = LSST_CAM_IMSIM_2
    """Name of this translation class"""

    supported_instrument = LSST_CAM_IMSIM_2
    """Supports the lsstCam instrument."""

    _const_map = {
        "instrument": LSST_CAM_IMSIM_2,
    ...
    cameraPolicyFile = "policy/imsim2.yaml"
