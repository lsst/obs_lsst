...
__all__ = (
    ...
    "LsstCamSimRawFormatter",
    "LsstTS8RawFormatter",
    "LsstTS3RawFormatter",
    "LsstComCamRawFormatter",
    "LsstComCamSimRawFormatter",
...
from ._instrument import LsstCam, Latiss, \
    ...
    LsstTS3, LsstUCDCam, LsstComCam, LsstComCamSim, LsstCamSim
...
class LsstCamRawFormatter(FitsRawFormatterBase):
    ...
    def readFull(self):
        # Docstring inherited.
        rawFile = self._reader_uri.ospath
...
class LsstCamSimRawFormatter(LsstCamRawFormatter):
    translatorClass = LsstCamSimTranslator
    _instrument = LsstCamSim
    filterDefinitions = LsstCamSim.filterDefinitions
...
class LsstComCamSimRawFormatter(LsstCamRawFormatter):
    translatorClass = LsstComCamSimTranslator
    _instrument = LsstComCamSim
    filterDefinitions = LsstComCamSim.filterDefinitions
