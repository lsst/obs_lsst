...
with Butler.from_config(repo) as butler:
    ...
    with Butler.from_config(repo, collections="u/lsstccs/ptc_13144_w_2023_22/20230607T013806Z") as butlerPtc:
        ...
        for detector in camera:
            ...
            # When we take these images the projector illuminates 1/4 of the
            # sensor, but we can only limit the readout to a single raft.
            ...
            # and only 5 are relevant per amplifier.  The rest are filled with
            # NaN.
