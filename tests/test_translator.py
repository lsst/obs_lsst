        ...
        test_data = (("ts8-E2V-CCD250-179_lambda_bias_024_6006D_20180724104156.yaml",
                     ...
                     ("ts8-TS_C_20220711_000174_R22_S00.yaml",
                      dict(telescope=None,
                           ...
                           detector_exposure_id=202207111711159018,
                           detector_group="RTM-004",
                           detector_name="S00",
                           detector_num=18,
                           detector_serial="ITL-3800C-372",
                           exposure_id=202207111711159,
                           exposure_group="202207111711159",
                           ...
                           visit_id=202207111711159)),
                     ("ts8-TS_C_20230512_000021_R22_S02.yaml",
                      dict(telescope=None,
                           instrument="LSST-TS8",
                           dark_time=15.165*u.s,
                           detector_exposure_id=202305121917441020,
                           detector_group="RTM-004",
                           detector_name="S02",
                           detector_num=20,
                           detector_serial="ITL-3800C-380",
                           exposure_id=202305121917441,
                           exposure_group="202305121917441",
                           exposure_time=15.0*u.s,
                           focus_z=0.0*u.mm,
