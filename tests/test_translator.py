...
class LsstMetadataTranslatorTestCase(unittest.TestCase, MetadataAssertHelper):
    ...
    def test_lsstCam_translator(self):
        test_data = (("lsstCam-MC_O_20260315_000051_R01_S01.yaml",
                      dict(telescope="Simonyi Survey Telescope",
                           instrument="LSSTCam",
                           boresight_rotation_coord="unknown",
                           boresight_rotation_angle=89.30082602885373*u.deg,
                           can_see_sky=False,
                           dark_time=5.01371*u.s,
                           detector_exposure_id=0xb8e803301,
                           detector_group="R01",
                           detector_name="S01",
                           detector_num=1,
                           detector_serial="ITL-3800C-226",
                           exposure_id=2026031500051,
                           exposure_group="2026-03-15T22:50:34.110",
                           exposure_time=5.0*u.s,
                           exposure_time_requested=5.0*u.s,
                           focus_z=-2.1340826845674403*u.mm,
                           group_counter_end=51,
                           group_counter_start=51,
                           has_simulated_content=False,
                           object="azel_target",
                           observation_counter=51,
                           observation_id="MC_O_20260315_000051",
                           observation_type="dark",
                           observation_reason="tmacheckout",
                           observing_day=20260315,
                           observing_day_offset=astropy.time.TimeDelta(43200.0, scale="tai", format="sec"),
                           physical_filter="i_39",
                           pressure=74150.0*u.Pa,
                           relative_humidity=58.849998474121094,
                           science_program="BLOCK-T250",
                           temperature=11.800000190734863*u.deg_C,
                           visit_id=3535446341100000)),
                     ...
                     ("lsstCam-MC_C_20190322_000002_R10_S22.yaml",
                      dict(telescope="Simonyi Survey Telescope",
                           ...
                           exposure_time_requested=1.0*u.s,
                           focus_z=0.0*u.mm,
                           group_counter_end=2,
                     ...
                     ("lsstCam-MC_C_20190406_000643_R10_S00.yaml",
                      dict(telescope="Simonyi Survey Telescope",
                           ...
                           exposure_time_requested=999.99*u.s,
                           focus_z=0.0*u.mm,
                     ...
                     ("lsstCam-MC_O_20250415_000060_R01_S01.yaml",
                      dict(telescope="Simonyi Survey Telescope",
                           ...
                           exposure_time=15.000998497009277*u.s,
                           exposure_time_requested=15.0*u.s,
                     ...
                     ("lsstCam-MC_O_20250415_000228_R10_S20.yaml",
                      dict(telescope="Simonyi Survey Telescope",
                           instrument="LSSTCam",
                           boresight_rotation_coord="sky",
                           boresight_rotation_angle=28.988651816521724*u.deg,
                           can_see_sky=True,
                           dark_time=30.9422*u.s,
                           detector_exposure_id=0xae780e421,
                           detector_group="R10",
                           detector_name="S20",
                           detector_num=33,
                           detector_serial="ITL-3800C-377",
                           exposure_id=2025041500228,
                           exposure_group="2025-04-16T07:03:14.565#1",
                           exposure_time=30.001051664352417*u.s,
                           exposure_time_requested=30.0*u.s,
                           focus_z=-2.8329331104974114*u.mm,
                           group_counter_end=228,
                           group_counter_start=228,
                           has_simulated_content=False,
                           object="UNKNOWN",
                           observation_counter=228,
                           observation_id="MC_O_20250415_000228",
                           observation_type="acq",
                           observation_reason="infocus_clt-001",
                           observing_day=20250415,
                           observing_day_offset=astropy.time.TimeDelta(43200.0, scale="tai", format="sec"),
                           physical_filter="i_39",
                           pressure=74225.0*u.Pa,
                           relative_humidity=25.475000381469727,
                           science_program="BLOCK-T417",
                           temperature=10.350000381469727*u.deg_C,
                           visit_id=3247165945650001)),
                     ("lsstCam-MC_O_20250422_000250_R01_S01.yaml",
                      dict(telescope="Simonyi Survey Telescope",
                           instrument="LSSTCam",
                           boresight_rotation_coord="sky",
                           boresight_rotation_angle=138.6291409919304*u.deg,
                           can_see_sky=True,
                           dark_time=15.9482*u.s,
                           detector_exposure_id=0xaeb00fa01,
                           detector_group="R01",
                           detector_name="S01",
                           detector_num=1,
                           detector_serial="ITL-3800C-226",
                           exposure_id=2025042200250,
                           exposure_group="2025-04-23T03:52:21.287",
                           exposure_time=15.000065088272095*u.s,
                           exposure_time_requested=15.0*u.s,
                           focus_z=-4.0921929561356105*u.mm,
                           group_counter_end=250,
                           group_counter_start=250,
                           has_simulated_content=False,
                           object="Rubin_SV_216_-17",
                           observation_counter=250,
                           observation_id="MC_O_20250422_000250",
                           observation_type="acq",
                           observation_reason="infocus_clt-001",
                           observing_day=20250422,
                           observing_day_offset=astropy.time.TimeDelta(43200.0, scale="tai", format="sec"),
                           physical_filter="r_57",
                           pressure=74255.0*u.Pa,
                           relative_humidity=29.475000381469727,
                           science_program="BLOCK-T417",
                           temperature=11.274999618530273*u.deg_C,
                           visit_id=3253099412870000)),
                     ("lsstCam-MC_C_20250425_000031_R01_S01.yaml",
                      dict(telescope="Simonyi Survey Telescope",
                           instrument="LSSTCam",
                           boresight_rotation_coord="unknown",
                           boresight_rotation_angle=0.0*u.deg,
                           can_see_sky=None,
                           dark_time=1469.57*u.s,
                           detector_exposure_id=0xaec801f01,
                           detector_group="R01",
                           detector_name="S01",
                           detector_num=1,
                           detector_serial="ITL-3800C-226",
                           exposure_id=2025042500031,
                           exposure_group="2025042500031",
                           exposure_time=2.767*u.s,
                           exposure_time_requested=2.767*u.s,
                           focus_z=0.0*u.mm,
                           group_counter_end=31,
                           group_counter_start=31,
                           has_simulated_content=False,
                           object="UNKNOWN",
                           observation_counter=31,
                           observation_id="MC_C_20250425_000031",
                           observation_type="unknown",
                           observation_reason="unknown",
                           observing_day=20250425,
                           observing_day_offset=astropy.time.TimeDelta(43200.0, scale="tai", format="sec"),
                           physical_filter="unknown",
                           pressure=None,
                           relative_humidity=None,
                           science_program="unknown",
                           temperature=None,
                           visit_id=2025042500031)),
                     ("lsstCam-MC_O_20250609_000578_R01_S01.yaml",
                      dict(telescope="Simonyi Survey Telescope",
                           instrument="LSSTCam",
                           boresight_rotation_coord="sky",
                           boresight_rotation_angle=131.35723576573005*u.deg,
                           can_see_sky=True,
                           dark_time=30.9487*u.s,
                           detector_exposure_id=0xb03024201,
                           detector_group="R01",
                           detector_name="S01",
                           detector_num=1,
                           detector_serial="ITL-3800C-226",
                           exposure_id=2025060900578,
                           exposure_group="2025-06-10T07:31:26.692",
                           exposure_time=30.000904321670532*u.s,
                           exposure_time_requested=30.0*u.s,
                           focus_z=-3.200530845386125*u.mm,
                           group_counter_end=578,
                           group_counter_start=578,
                           has_simulated_content=False,
                           object="Rubin_SV_320_-15",
                           observation_counter=578,
                           observation_id="MC_O_20250609_000578",
                           observation_type="science",
                           observation_reason="field_survey_science",
                           observing_day=20250609,
                           observing_day_offset=astropy.time.TimeDelta(43200.0, scale="tai", format="sec"),
                           physical_filter="z_20",
                           pressure=74210.0*u.Pa,
                           relative_humidity=11.175000190734863,
                           science_program="BLOCK-365",
                           temperature=9.699999809265137*u.deg_C,
                           visit_id=3294702866920000)),
                     ("lsstCam-MC_O_20251121_000156_R44_SW0.json",
                      dict(telescope="Simonyi Survey Telescope",
                           instrument="LSSTCam",
                           boresight_rotation_coord="sky",
                           boresight_rotation_angle=290.31522740370315*u.deg,
                           can_see_sky=True,
                           dark_time=30.9318*u.s,
                           detector_exposure_id=0xb55809ccb,
                           detector_group="R44",
                           detector_name="SW0",
                           detector_num=203,
                           detector_serial="ITL-4400B-025",
                           exposure_id=2025112100156,
                           exposure_group="2025-11-22T03:25:16.951",
                           exposure_time=30.00100302696228*u.s,
                           exposure_time_requested=30.0*u.s,
                           focus_z=-1.903796731126306*u.mm,
                           group_counter_end=156,
                           group_counter_start=156,
                           has_simulated_content=False,
                           object="lowdust GW_case_large_1",
                           observation_counter=156,
                           observation_id="MC_O_20251121_000156",
                           observation_type="science",
                           observation_reason="too_gw_case_large_1_i3",
                           observing_day=20251121,
                           observing_day_offset=astropy.time.TimeDelta(43200.0, scale="tai", format="sec"),
                           physical_filter="i_39",
                           pressure=74225.0*u.Pa,
                           relative_humidity=29.75,
                           science_program="BLOCK-407",
                           temperature=12.350000381469727*u.deg_C,
                           wcs_params=dict(max_sep=2.0),
                           visit_id=3437115169510000)),
                     )
    ...
    def test_comCam_translator(self):
        test_data = (("comCam-CC_C_20190530_000001_R22_S00.yaml",
                     ...
                     ("comCam-CC_O_20240806_000006_R22_S00.yaml",
                      dict(telescope="Simonyi Survey Telescope",
                           instrument="LSSTComCam",
                           boresight_rotation_coord="unknown",
                           can_see_sky=False,
                           wcs_params=dict(max_sep=2.5),
                           dark_time=0.660616*u.s,
                           detector_exposure_id=44719670784,
                           detector_group="R22",
                           detector_name="S00",
                           detector_num=0,
                           detector_serial="ITL-3800C-229",
                           exposure_id=2024080600006,
                           exposure_group="2024-08-06T15:35:02.269",
                           exposure_time=0.2*u.s,
                           exposure_time_requested=0.2*u.s,
                           focus_z=0.0*u.mm,
                           group_counter_end=6,
                           group_counter_start=6,
                           has_simulated_content=True,
                           object="UNKNOWN",
                           observation_counter=6,
                           observation_id="CC_O_20240806_000006",
                           observation_type="flat",
                           observation_reason="flat",
                           observing_day=20240806,
                           observing_day_offset=astropy.time.TimeDelta(43200.0, scale="tai", format="sec"),
                           physical_filter="g_01",
                           pressure=74060.0 * u.Pa,
                           relative_humidity=47.400001525878906,
                           science_program="unknown",
                           temperature=1.3250000476837158 * u.deg_C,
                           visit_id=3028881022690000)),
    ...
    def test_latiss_translator(self):
        test_data = (("latiss-2018-09-20-05700065-det000.yaml",
                      dict(telescope="Rubin Auxiliary Telescope",
                           ...
                           exposure_time_requested=27.0*u.s,
                           focus_z=0.0*u.mm,
                     ...
                     ("latiss-AT_O_20190306_000014.yaml",
                      dict(telescope="Rubin Auxiliary Telescope",
                           ...
                           exposure_time_requested=1.06*u.s,
                           focus_z=0.0*u.mm,
                     ...
                     ("latiss-AT_O_20191031_000004.yaml",
                      dict(telescope="Rubin Auxiliary Telescope",
                           ...
                           exposure_time_requested=3.0*u.s,
                           focus_z=0.0*u.mm,
                           group_counter_end=4,
                     ...
                     ("latiss-AT_O_20191113_000061.yaml",
                      dict(telescope="Rubin Auxiliary Telescope",
                           ...
                           exposure_time_requested=0.5*u.s,
                           focus_z=0.0*u.mm,
                     ...
                     ("latiss-AT_O_20200121_000045.yaml",
                      dict(telescope="Rubin Auxiliary Telescope",
                           ...
                           exposure_time_requested=100.0*u.s,
    ...
    def test_ts3_translator(self):
        test_data = (("ts3-E2V-CCD250-411_lambda_flat_1000_025_20181115075559.yaml",
                      dict(telescope=None,
                           ...
                           exposure_time_requested=44.631*u.s,
                           focus_z=0.0*u.mm,
