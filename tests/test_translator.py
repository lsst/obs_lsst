    ...
    def test_lsstCam_translator(self):
        test_data = (("lsstCam-MC_C_20190319_000001_R10_S02.yaml",
                      dict(telescope="LSST",
                           ...
                           dark_time=0.0*u.s,
                           detector_exposure_id=12019031900001029,
                           detector_group="R10",
                           detector_name="S02",
                           detector_num=29,
                           detector_serial="ITL-3800C-041",
                           exposure_id=12019031900001,
                           ...
                           temperature=None,
                           visit_id=12019031900001)),
                     ("lsstCam-MC_C_20190319_000001_R22_S21.yaml",
                      dict(telescope="LSST",
                           instrument="lsstCam",
                           boresight_rotation_coord="unknown",
                           dark_time=0.0*u.s,
                           detector_exposure_id=12019031900001097,
                           detector_group="R22",
                           detector_name="S21",
                           detector_num=97,
                     ...
                     ("lsstCam-MC_C_20190322_000002_R10_S22.yaml",
                      dict(telescope="LSST",
                           ...
                           boresight_rotation_coord="unknown",
                           dark_time=1.0*u.s,
                           detector_exposure_id=12019032200002035,
                           detector_group="R10",
                           detector_name="S22",
                           detector_num=35,
                           detector_serial="ITL-3800C-103",
                           exposure_id=12019032200002,
    ...
    def test_comCam_translator(self):
        test_data = (("comCam-CC_C_20190530_000001_R22_S00.yaml",
                      dict(telescope="LSST",
                           ...
                           boresight_rotation_coord="unknown",
                           dark_time=0.398*u.s,
                           detector_exposure_id=12019053000001000,
                           detector_group="R22",
                           detector_name="S00",
                           detector_num=0,
                           detector_serial="ITL-3800C-229",
                           exposure_id=12019053000001,
                           exposure_time=0.0*u.s,
                           object="UNKNOWN",
    ...
    def test_latiss_translator(self):
        test_data = (("latiss-2018-09-20-05700065-det000.yaml",
                      dict(telescope="LSSTAuxTel",
                           ...
                           boresight_rotation_coord="unknown",
                           dark_time=27.0*u.s,
                           detector_exposure_id=12018092000065,
                           detector_group="RXX",
                           detector_name="S00",
                           detector_num=0,
                           detector_serial="ITL-3800C-098",
                           exposure_id=12018092000065,
