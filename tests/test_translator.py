    ...
    def test_phosim_translator(self):
        test_data = (("phosim-lsst_a_204595_f3_R11_S02_E000.yaml",
                      dict(telescope="LSST",
                           ...
                           dark_time=30.0*u.s,
                           detector_exposure_id=2045950038,
                           detector_group="R11",
                           detector_name="S02",
                           detector_num=38,
    ...
    def test_imsim_translator(self):
        test_data = (("imsim-bias-lsst_a_3010002_R11_S00.yaml",
                      dict(telescope="LSST",
                           ...
                           boresight_rotation_coord="sky",
                           dark_time=0.0*u.s,
                           detector_exposure_id=30100020036,
                           detector_group="R11",
                           detector_name="S00",
                           detector_num=36,
                     ...
                     ("imsim-flats-lsst_a_5000007_R11_S20_i.yaml",
                      dict(telescope="LSST",
                           ...
                           boresight_rotation_coord="sky",
                           dark_time=30.0*u.s,
                           detector_exposure_id=50000070042,
                           detector_group="R11",
                           detector_name="S20",
                           detector_num=42,
                           detector_serial="LCA-11021_RTM-000",
                     ...
                     ("imsim-dark-lsst_a_4010003_R11_S11.yaml",
                      dict(telescope="LSST",
                           ...
                           boresight_rotation_coord="sky",
                           dark_time=500.0*u.s,
                           detector_exposure_id=40100030040,
                           detector_group="R11",
                           detector_name="S11",
                           detector_num=40,
                           detector_serial="LCA-11021_RTM-000",
    ...
    def test_ts8_translator(self):
        test_data = (("ts8-E2V-CCD250-179_lambda_bias_024_6006D_20180724104156.yaml",
                      dict(telescope="LSST",
                           ...
                           dark_time=0.0*u.s,
                           detector_exposure_id=20180724104156804,
                           detector_group="R00",
                           detector_name="S11",
                           detector_num=4,
                     ...
                     ("ts8-E2V-CCD250-200-Dev_lambda_flat_0700_6006D_20180724102845.yaml",
                      dict(telescope="LSST",
                           ...
                           detector_exposure_id=20180724102845302,
                           detector_group="R00",
                           detector_name="S02",
                           detector_num=2,
