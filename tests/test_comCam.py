...
class TestLsstCam(ObsLsstObsBaseOverrides, ObsLsstButlerTests):
    ...
    def setUp(self):
        dataIds = {'raw': {'visit': 2019053000001, 'detectorName': 'S00', 'raftName': 'R22'},
        ...
        exposureIds = {'raw': 2019053000001000,
                       }
        filters = {'raw': 'NONE',
                   }
        exptimes = {'raw': 0.0,
        ...
        raw_subsets = (({'level': 'sensor', 'filter': 'NONE'}, 1),
                       ({'level': 'sensor', 'visit': 2019053000001}, 1),
                       ({'level': 'filter', 'visit': 2019053000001}, 1),
        ...
        queryMetadata = (({'visit': 2019053000001}, [(2019053000001, 'NONE')]),
                         ({'filter': 'NONE'}, [(2019053000001, 'NONE')]),
                         )
        ...
        metadata_output_path = os.path.join("processCcd_metadata/2019053000001-NONE/R22",
                                            "processCcdMetadata_2019053000001-NONE-R22-S00-det000.yaml")
        raw_filename = '2019053000001-R22-S00-det000-000.fits'
        default_level = 'visit'
    ...
    def testDetectorName(self):
        ...
        name = self.mapper._extractDetectorName({'visit': 2019053000001, 'detectorName': 'S00'})
        self.assertEqual(name, "R22_S00")

        name = self.mapper._extractDetectorName({'visit': 2019053000001, 'detector': 0})
        self.assertEqual(name, "R22_S00")

        name = self.mapper._extractDetectorName({'detector': 0})
        self.assertEqual(name, "R22_S00")

        name = self.mapper._extractDetectorName({'visit': 2019053000001})
        self.assertEqual(name, "R22_S00")
